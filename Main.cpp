...
//call libraries used for shear and moment computations
#include "shear.h"
#include "moment.h"
#include <cmath>
#include <iostream>
...
//functions for computation of deflection under concentrated loading, uniformly distributed loading and triangular loading
...
//function for printing of menu, no return values
void menu1(float length, float b, float h, float e, float inertia)
{
	cout << "************************BEAM ANALYSIS PROGRAM************************" << endl << endl;
...
//function for printing menu for results
int menu2(int &z)
{
...
//variable declaration
	...
	//asking of input from the user, beam specifications
	...
	//iterative statements for different load cases
	switch(y)
	{
		case 1:
